...
public class FundamentalAgentTest {
    ...
    public FundamentalAgent createAgent(Object... parameters) {
        return createAgent(
            fundamental, 
            market, 
            rand, 
    ...
    public FundamentalAgent createAgent(
        final FundamentalValue fundamental, 
        final Market market, 
        final Random rand, 
        final Object... parameters
        ) {
        return new FundamentalAgent(
            exec, 
            TimeStamp.ZERO, 
            fundamental, 
            sip, 
    ...
    public static void setUpClass() throws IOException{
        ...
        log = Log.create(DEBUG, new File(Consts.TEST_OUTPUT_DIR + "FundamentalAgentTest.log"));
    ...
    public void withdrawTest() {
        ...
        FundamentalAgent agent = createAgent(
            Keys.MAX_POSITION, 2,
    ...
    @Test
    public void randTestFundamental(){
        log.log(DEBUG, "Testing FundamentalAgent 100 random argument bids are correct");
        ...
        for(int i = 0; i<100; i++){
            ...
            //Creating ZIAgent
            FundamentalAgent testAgent = createAgent(
                Keys.MAX_POSITION, 2,
                Keys.WITHDRAW_ORDERS, true);
